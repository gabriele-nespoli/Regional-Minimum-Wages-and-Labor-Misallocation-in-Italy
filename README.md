...
Contains an automated Python workflow with Selenium to log into the commercial database Orbis via single sign-on (SSO), load a saved search by XPath, and export balance-sheet data on the desired firms in batches, with retries/timeouts, sequential file naming, resume support, and integrity checks.
